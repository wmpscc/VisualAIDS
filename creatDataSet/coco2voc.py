...
dst_base = os.path.join("data", "VOCdevkitCOCO2017", "VOCCOCO")
...
sets = {
    "train": os.path.join(src_base, "/media/heolis/967EC257F5104FE6/cocod/annotations_trainval2017/annotations/instances_train2017.json"),
    "test": os.path.join(src_base, "/media/heolis/967EC257F5104FE6/cocod/annotations_trainval2017/annotations/instances_val2017.json"),
}
