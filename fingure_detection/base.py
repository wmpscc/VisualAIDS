        ...
        try:
            ...
            if defects is not None:
                if area_cnt > 6000:
                    ...
                    cv.putText(frame, "Can't detect anything", (0, 70), cv.FONT_HERSHEY_SIMPLEX, 0.5, (0, 0, 150), 2)
        except:
            cv.putText(frame, "Put your hand in the frame8", (0, 70), cv.FONT_HERSHEY_SIMPLEX, 0.5, (0, 0, 255), 2)
